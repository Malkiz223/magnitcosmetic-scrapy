...
class MagnitcosmeticSpider(scrapy.Spider):
    ...
    def __init__(self, **kwargs):
        ...
        self.shop_xml_code = '19077662880'  # г. Москва, ул. Абельмановская, 6, 18850594800 - shop_xml_code по умолчанию
        # шлём POST-запрос по данному url, чтобы получить данные о цене товара
        self.catalog_load_remains_url = 'https://magnitcosmetic.ru/local/ajax/load_remains/catalog_load_remains.php'
        self.proxy_list = [
            '188.130.186.88:3000',
            '109.248.13.233:3000',
            '188.130.211.27:3000',
